module TiketComApi
  class Client
    ...
    module Tags
      # Returns extended information of a given TiketComApi tag
      #
      # @overload tag(tag)
      #   @param tag [String] An TiketComApi tag name
      ...
      # Returns a list of recent media items for a given TiketComApi tag
      #
      # @overload tag_recent_media(tag, options={})
      #   @param tag-name [String] An TiketComApi tag name.
      ...
      #     TiketComApi.tag_recent_media('cat')
