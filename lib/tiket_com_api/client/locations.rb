module TiketComApi
  class Client
    ...
    module Locations
      # Returns extended information of a given TiketComApi location
      #
      # @overload location(id)
      #   @param location [Integer] An TiketComApi location ID
      #   @return [Hashie::Mash] The requested location.
      #   @example Return extended information for the TiketComApi office
      #     TiketComApi.location(514276)
      # @format :json
      # @authenticated false
      # @rate_limited true
      ...
      # Returns a list of recent media items for a given TiketComApi location
      #
      # @overload location_recent_media(id, options={})
      #   @param user [Integer] An TiketComApi location ID.
      ...
      #   @return [Hashie::Mash]
      #   @example Return a list of the most recent media items taken at the TiketComApi office
      #     TiketComApi.location_recent_media(514276)
      ...
      # Returns TiketComApi locations within proximity of given lat,lng or foursquare venue id
      #
      ...
      #     TiketComApi.location_search("3fd66200f964a520c5f11ee3") (Schiller's Liquor Bar, 131 Rivington St., NY, NY 10002)
      #   @example 2: Return locations around 37.7808851, -122.3948632 (164 S Park, SF, CA USA)
      #     TiketComApi.location_search("37.7808851", "-122.3948632")
