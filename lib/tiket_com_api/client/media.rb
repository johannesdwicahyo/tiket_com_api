module TiketComApi
  class Client
    ...
    module Media
      ...
      #   @param shortcode [String] An TiketComApi media item shortcode
      #   @return [Hashie::Mash] The requested media item.
      #   @example Return extended information for media item with shortcode 'D'
      #     TiketComApi.media_shortcode('D')
      # @format none
      # @authenticated false unless requesting media from a protected user
      #
      #   If getting this data of a protected user, you must authenticate (and be allowed to see that user).
      ...
      #   TiketComApi.media_search("37.7808851", "-122.3948632")
