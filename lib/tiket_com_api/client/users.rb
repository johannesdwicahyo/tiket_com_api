module TiketComApi
  class Client
    ...
    module Users
      ...
      #   @param user [Integer] An TiketComApi user ID
      ...
      #   TiketComApi.user_search("Shayne Sweeney")
      ...
      #     TiketComApi.user_follows(4) # @mikeyk user ID being 4
    ...
    #     TiketComApi.user_followed_by(4) # @mikeyk user ID being 4
    ...
    #     TiketComApi.user_media_feed() # assuming @shayne is the authorized user
    # @format :json
    # @authenticated true
    # @rate_limited true
    ...
    #     TiketComApi.user_recent_media(4) # @mikeyk user ID being 4
    ...
    #     TiketComApi.user_relationship(4) # @mikeyk user ID being 4
