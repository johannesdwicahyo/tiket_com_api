...
module TiketComApi
  ...
  module Configuration
    # An array of valid keys in the options hash when configuring a {TiketComApi::API}
    VALID_OPTIONS_KEYS = [
      :access_token,
      :adapter,
      :client_id,
    ...
    DEFAULT_ENDPOINT = 'https://api-sandbox.tiket.com/'.freeze
    ...
    DEFAULT_USER_AGENT = "TiketComApi Ruby Gem #{TiketComApi::VERSION}".freeze
